package com.claudiu.greenhouse.pojo;

import com.claudiu.greenhouse.constants.DHT22_Declares;
...
public class DHT22Sensor {
    ...
    private DHT22Sensor.DataInGpioListener listener;
    ...
    public DHT22Sensor(Context pi4j, Console console, int dataPinNum, String traceLevel) {
        super();
    ...
    private void init() {
        System.setProperty("org.slf4j.simpleLogger.log." + DHT22Sensor.class.getName(), this.traceLevel);
        this.logger = LoggerFactory.getLogger(DHT22Sensor.class);
